...
namespace DotSee.Discipline.VirtualNodes
{
    ...
    {
        public static bool IsVirtualNode(this IPublishedContent item, VirtualNodesRuleManager virtualNodesRuleManager)
        {
            foreach (string rule in virtualNodesRuleManager.Rules)
            {
