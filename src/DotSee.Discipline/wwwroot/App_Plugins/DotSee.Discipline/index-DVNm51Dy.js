...
function I(i) {
  ...
  return {
    ...
    weight: 100,
    api: () => import("./toggle-variants.action-kRBnvvsq.js"),
  ...
  return [
    {
      ...
      api: () => import("./prev-version.action-D-IdF8bs.js"),
...
const P = "DotSee.Discipline.Settings.Workspace", f = "DotSee.Discipline.Settings.Menu", H = "DotSee.Discipline.Settings.SidebarApp", k = "DotSee.Discipline.Settings.MenuItem", W = [
  {
    ...
    element: () => import("./discipline-settings.workspace.element-CvJxvnN8.js"),
    meta: {
      entityType: g
    }
  },
...
//# sourceMappingURL=index-DVNm51Dy.js.map
