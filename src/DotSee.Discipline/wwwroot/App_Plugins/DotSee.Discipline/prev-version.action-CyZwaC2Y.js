...
var e = (s, a, t) => (d(s, a, "read from private field"), t ? t.call(s) : a.get(s)), p = (s, a, t) => a.has(s) ? v("Cannot add the same private member more than once") : a instanceof WeakSet ? a.add(s) : a.set(s, t), T = (s, a, t, i) => (d(s, a, "write to private field"), i ? i.call(s, t) : a.set(s, t), t), u = (s, a, t) => (d(s, a, "access private method"), t);
...
import { a as X } from "./index-2_dCitlK.js";
function D() {
...
class J extends U {
  ...
  getDisabledState() {
    ...
    const t = u(this, o, w).call(this), i = u(this, o, C).call(this, t), r = (l = e(this, n)) == null ? void 0 : l.getAlias();
    if (!i || !r) return !0;
  ...
  async execute() {
    if (await e(this, y), await Promise.race([e(this, A), new Promise((E) => setTimeout(E, 200))]), !e(this, n) || !e(this, g) || !e(this, f))
      return;
    const t = u(this, o, w).call(this), i = u(this, o, C).call(this, t), r = e(this, n).getAlias();
    if (!i || !r) return;
    const c = e(this, n).getVariantId(), l = (c == null ? void 0 : c.culture) ?? null, h = e(this, n).getValue(), m = x(h), V = await e(this, f).getLatestToken(), k = await I(i, r, l, m, V, t);
...
n = new WeakMap(), g = new WeakMap(), f = new WeakMap(), P = new WeakMap(), y = new WeakMap(), A = new WeakMap(), o = new WeakSet(), _ = async function() {
  ...
  const t = u(this, o, w).call(this), i = u(this, o, C).call(this, t), r = e(this, n).getAlias();
  if (!i || !r) return;
  const c = ((V = e(this, n).getVariantId()) == null ? void 0 : V.culture) ?? null, l = e(this, n).getValue(), h = x(l), m = await e(this, f).getLatestToken();
  await S(i, r, c, h, m, t);
}, w = function() {
  var t;
  if (e(this, P)) {
...
//# sourceMappingURL=prev-version.action-CyZwaC2Y.js.map
