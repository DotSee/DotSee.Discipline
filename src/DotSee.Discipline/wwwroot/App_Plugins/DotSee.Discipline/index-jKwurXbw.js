...
function I(i) {
  return {
    ...
    weight: 100,
    api: () => import("./toggle-variants.action-sV-0hPgp.js"),
  ...
  return [
    {
      ...
      api: () => import("./prev-version.action-DVknu0ZD.js"),
...
const P = "DotSee.Discipline.Settings.Workspace", h = "DotSee.Discipline.Settings.Menu", H = "DotSee.Discipline.Settings.SidebarApp", k = "DotSee.Discipline.Settings.MenuItem", W = [
  {
    ...
    element: () => import("./discipline-settings.workspace.element-Dkzahe6W.js"),
    meta: {
      entityType: T
    }
  },
...
//# sourceMappingURL=index-jKwurXbw.js.map
